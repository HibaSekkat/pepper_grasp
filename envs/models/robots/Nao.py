...
class Nao(model_wrapper.ModelWrapper, model_with_file.ModelWithFile):

    ROBOT_MODEL_NAME: str = "Nao"
    DEFAULT_PREFIX: str = "Nao_"
    ...
    def get_model_file(cls, fuel: bool = False) -> str:
        ...
        if fuel:
            ...
            return scenario_gazebo.get_model_file_from_fuel(
                "https://fuel.gazebosim.org/1.0/OpenRobotics/models/NAO with Ignition position controller"
